...
def _solve_with_tolerance(config: ScheduleConfig, stats: Dict, tolerance: int, time_limit: int) -> ScheduleResult:
    ...
    for e in employees:
        if e.is_extra_weekend:
            ...
            # This ensures the extra-weekend employee's total weekdays match others
    ...
    for e in employees:
        ...
        if e in restricted_sat_only:
            ...
            # Extra WE: No Sat/Sun balance constraint
    ...
    # Extra WE employees have higher counts, exclude from spread
